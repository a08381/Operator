...
public class BlockFarmland extends Block {
    ...
    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        ...
        if (!this.hasWater(worldIn, pos) && !worldIn.isRainingAt(pos.up())) {
            if (i > 0) {
                ...
                this.turnToDirt(worldIn, pos, FarmlandChangeEvent.Type.NATRUAL);
            }
        } else if (i < 7) {
    ...
    public void onFallenUpon(World worldIn, BlockPos pos, Entity entityIn, float fallDistance) {
        ...
        {
            this.turnToDirt(worldIn, pos, FarmlandChangeEvent.Type.FALLEN);
        }

        super.onFallenUpon(worldIn, pos, entityIn, fallDistance);
    }

    private void turnToDirt(World p_190970_1_, BlockPos p_190970_2_, @Nullable FarmlandChangeEvent.Type type) {
        FarmlandChangeEvent event = new FarmlandChangeEvent(p_190970_1_, p_190970_2_, p_190970_1_.getBlockState(p_190970_2_), type);
